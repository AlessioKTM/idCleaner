...
class BinFolderCleaner(BaseFolderCleaner):
    ...
    def _applying(self, mailbox, categories):
        ...
        self.record.write(f"BinCleaner: Preparing to permanently delete {total} messages...")
        ...
        try:
            ...
            self.record.write(f"BinCleaner: Permanently deleted batch of {len(chunk)} messages.")
        except Exception as e:
            self.record.write(f"BinCleaner Error deleting batch: {e}")
